...
void create_dosbox_ui()
{
  ...
  gotoxy(2, 1);
  print_color_string("Welcome to Hades OS (x86 v1.0)", BRIGHT_GREEN, BLUE);

  gotoxy(2, 3);
  print_color_string("Created by: ", WHITE, BLUE);
  
  gotoxy(21, 3);
  print_color_string("Makdosx Hacker!", YELLOW, BLUE);
  ...
  gotoxy(2, 10);
  print_color_string("Hades Micro Kernel", BRIGHT_GREEN, BLUE);

  gotoxy(2, 11);
  print_color_string("The Hades Kernel Source:", BRIGHT_GREEN, BLUE);

  gotoxy(28, 11);
  print_color_string("https://github.com/makdosx/HadesOS", YELLOW, BLUE);

  gotoxy(0, 14);
  print_color_string("root@HadesOS:>>", WHITE, BLACK);
